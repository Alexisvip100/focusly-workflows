...
@strawberry.type
class Query(TaskQuery, WorkspaceQuery, TagQuery, InsightsQuery, ProjectGroupQuery):
    """Combined Query class with all entity queries"""
    pass


@strawberry.type
class Mutation(TaskMutation, WorkspaceMutation, AuthMutation, ProjectGroupMutation):
